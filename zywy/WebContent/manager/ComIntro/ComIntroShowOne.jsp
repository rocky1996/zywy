            ...
            <div class="panel">
                <div>
                    <div style="margin-top: 10px;display: inline-block;">
                        <a href="${pageContext.request.contextPath }/servlet/ComIntroServlet?operation=showAll" style="font-size: 25px;background-color: #7aba7b;color: white;padding: 5px;font-weight:200;"> &lt; 返回 </a>
                    </div>
 				<c:if test="${!empty ci}">
