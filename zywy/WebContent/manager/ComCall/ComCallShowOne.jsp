            ...
            <div class="panel">
                <div>
                    <div style="margin-top: 10px;display: inline-block;">
                        <a href="${pageContext.request.contextPath }/servlet/ComCallServlet?operation=showAll" style="font-size: 25px;background-color: #7aba7b;color: white;padding: 5px;font-weight:200;"> &lt; 返回 </a>
                    </div>
 				<c:if test="${!empty cc}">
                ...
                <div class="header topic_header" style="display: inline-block;">
                    <div class="author_content">
                        <div class="topic_content">
                            <div class="markdown-text" style="padding: 2rem;">${cc.control }</div>
               </c:if>
                        </div>
                    </div>
                </div>
