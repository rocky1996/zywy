...
<html lang="en">
	...
	<!--目录-->
			  ...
			  <ul class="menu_count_ul">
			  	...
			  	<li><b><a href="#">公司介绍</a></b>
			  		<ul class="menu_count_secondul1">
			  			...
			  			<li><b><a href="#">组织架构</a></b></li>
			  			<hr width="89px" noshade="noshade" size="1" color="#eee" style="margin-left:-39px;" />
			  			<li><b><a href="#">企业文化</a></b></li>
			  			<hr width="89px" noshade="noshade" size="1" color="#eee" style="margin-left:-39px;" />
			  			<li><b><a href="#">团队建设</a></b></li>
			  			<hr width="89px" noshade="noshade" size="1" color="#eee" style="margin-left:-39px;" />
			  			<li style="margin-top:-5px;"><b><a href="#">大事记</a></b></li>
			  		</ul>
			  	</li>
			  	<li><img src="../../images/dh_fgx.gif" style="margin-left:20px;" /></li>
			  	<li><b><a href="#">新闻中心</a></b>
			  	    <ul class="menu_count_secondul2">
			  			<li><b><a href="#">公司新闻</a></b></li>
			  			<hr width="89px" noshade="noshade" size="1" color="#eee" style="margin-left:-39px;" />
			  			<li><b><a href="#">地方动态</a></b></li>
			  			<hr width="89px" noshade="noshade" size="1" color="#eee" style="margin-left:-39px;" />
			  			<li><b><a href="#">媒体新闻</a></b></li>
			  		</ul>
			  	</li>
			  	<li><img src="../../images/dh_fgx.gif" style="margin-left:20px;" /></li>
			  	<li><b><a href="#">产品服务</a></b>
			  		<ul class="menu_count_secondul3">
			  			<li><b><a href="#">家政服务</a></b></li>
			  			<hr width="89px" noshade="noshade" size="1" color="#eee" style="margin-left:-39px;" />
			  			<li><b><a href="#">汽车维修</a></b></li>
			  			<hr width="89px" noshade="noshade" size="1" color="#eee" style="margin-left:-39px;" />
			  			<li><b><a href="#">便民维修</a></b></li>
			  		</ul>
			  	</li>
			  	<li><img src="../../images/dh_fgx.gif" style="margin-left:20px;" /></li>
			  	<li><b><a href="#">社区生活</a></b>
			  		<ul class="menu_count_secondul4">
			  			<li><b><a href="#">业主之家</a></b></li>
			  		</ul>
			  	</li>
			  	<li><img src="../../images/dh_fgx.gif" style="margin-left:20px;" /></li>
			  	<li><b><a href="#">加入庄勇</a></b>
			  		<ul class="menu_count_secondul5">
			  			<li><b><a href="#">招聘信息</a></b></li>
			  		</ul>
			  	</li>
			  	<li><img src="../../images/dh_fgx.gif" style="margin-left:20px;" /></li>
			  	<li><b><a href="#">议投诉建</a></b>
			  		<ul class="menu_count_secondul6">
			  			<li><b><a href="#">投诉电话</a></b></li>
			  		</ul>
			  	</li>
			  </ul>
			</div>
		...
		<header>
    <div><a href="${pageContext.request.contextPath }/servlet/TeamConServlet?operation=showAll"> &lt; 返回</a></div>
</header>
    ...
    <div id="content">
        <div class="panel">
            <div class="inner post">
                <form id="create_topic_form" action="${pageContext.request.contextPath }/servlet/TeamConServlet?operation=addTeamCon" method="post">
                    <fieldset>
