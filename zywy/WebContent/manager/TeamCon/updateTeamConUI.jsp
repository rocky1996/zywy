    ...
    <div id="content">
        <div class="panel">
            <div class="inner post">
                <form id="create_topic_form" action="${pageContext.request.contextPath }/servlet/TeamConServlet?operation=updateTeamCon" method="post">
                    <input type="hidden" name="teamid" value="${tc.teamid }">
                    <fieldset>
                        <textarea autofocus class='span9' id='title' name='title' rows='1' placeholder="标题字数 10 字以上">${tc.title }</textarea>
                         <!--  
                        ...
                        <div class='markdown_editor in_editor'>
                            <div class='markdown_in_editor'>
                                <textarea class='editor' name='control' rows='20' placeholder='文章支持 Markdown 语法, 请注意标记代码'>${tc.control }</textarea>
