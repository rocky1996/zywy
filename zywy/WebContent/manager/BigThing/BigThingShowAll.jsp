...
<html lang="en">
	...
	<body onload="change()">
					...
					<table>
						<tr>
							<td style="width:336px;">
								<form action="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=query" method="post" style="float:right;">
		...
		<form id="ff" action="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=DelAllServlet" method="post">
			<table align="center" border="0" width="85%">
						...
						<c:if test="${!empty page.records }">
							<table border="1" width="100%">
								...
								<c:forEach items="${page.records }" var="c" varStatus="vs">
									<tr>
										<td align="center"><input type="checkbox" name="ids" value="${c.bigid }"></td>
										<td align="center">${c.title }</td>
										<td align="center"><a href="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=showDetailOne&bigid=${c.bigid}">查看详情</a></td>
										<td align="center"><a href="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=updateBigThingUI&bigid=${c.bigid}">修改</a></td>
										<td align="center"><a href="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=deleteOne&bigid=${c.bigid}">删除</a></td>
				...
				<tr>
					<td align="center">
						...
						<a href="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=showAll">首页</a>&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=showAll&pagenum=${page.pagenum-1==0?1:page.pagenum-1}">上一页</a>
						
						<c:forEach begin="${page.startPage }" end="${page.endPage }" var="num">
							<a href="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=showAll&pagenum=${num}">${num }</a>
						</c:forEach>
						
						<a href="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=showAll&pagenum=${page.pagenum+1>page.totalpage?page.totalpage:page.pagenum+1}">下一页</a>&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=showAll&pagenum=${page.totalpage }">尾页</a>&nbsp;&nbsp;
						<select id="s1">
						...
						<script type="text/javascript">
							function jump(){
								...
								window.location.href="${pageContext.request.contextPath }/servlet/BigThingServlet?operation=showAll&pagenum="+num;
							}                                                      
						</script>
					</td>
				</tr>
