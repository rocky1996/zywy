				...
				<td>
					...
					<c:if test="${!empty cr }">
						<table border="1" width="100%">
							...
							<c:forEach items="${cr }" var="c" varStatus="vs">
								<tr>
									...
									<td align="center"><a href="${pageContext.request.contextPath }/servlet/ConRepServlet?operation=deleteOne&conid=${c.conid}">删除</a></td>
