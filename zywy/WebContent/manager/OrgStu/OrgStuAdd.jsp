...
<html lang="en">
	...
	<!--目录-->
		...
		<header>
    <div><a href="${pageContext.request.contextPath }/servlet/OrgStuServlet?operation=showAll"> &lt; 返回</a></div>
</header>
    ...
    <div id="content">
        <div class="panel">
            <div class="inner post">
                <form id="create_topic_form" action="${pageContext.request.contextPath }/servlet/OrgStuServlet?operation=addOrgStu" method="post">
                    <fieldset>
