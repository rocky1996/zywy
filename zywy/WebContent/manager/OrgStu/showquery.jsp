						...
						<table border="1" width="100%">
							...
							<c:forEach items="${cs }" var="c" varStatus="vs">
								<tr>
									...
									<td align="center"><a href="${pageContext.request.contextPath }/servlet/ComIntroServlet?operation=showDetailOne&orgid=${c.orgid}">查看详情</a></td>
									<td align="center"><a href="${pageContext.request.contextPath }/servlet/ComIntroServlet?operation=updateComIntroUI&orgid=${c.orgid}">修改</a></td>
									<td align="center"><a href="${pageContext.request.contextPath }/servlet/ComIntroServlet?operation=deleteOne&orgid=${c.orgid}">删除</a></td>
