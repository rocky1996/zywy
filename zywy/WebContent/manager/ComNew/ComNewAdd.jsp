...
<html lang="en">
	...
	<!--目录-->
		...
		<header>
    <div><a href="${pageContext.request.contextPath }/servlet/ComNewServlet?operation=showAll"> &lt; 返回</a></div>
</header>
    ...
    <div id="content">
        <div class="panel">
            <div class="inner post">
                <form id="create_topic_form" action="${pageContext.request.contextPath }/servlet/ComNewServlet?operation=addComIntro" method="post">
                    <fieldset>
